#############################################################################
# Makefile for building: jr
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Mar 4 16:36:55 2013
# Project:  jr.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile jr.pro
#############################################################################
...
Makefile: jr.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/jr1.0.0 || $(MKDIR) .tmp/jr1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/jr1.0.0/ && $(COPY_FILE) --parents client.h server.h ui.h .tmp/jr1.0.0/ && $(COPY_FILE) --parents client.cpp main.cpp server.cpp ui.cpp .tmp/jr1.0.0/ && (cd `dirname .tmp/jr1.0.0` && $(TAR) jr1.0.0.tar jr1.0.0 && $(COMPRESS) jr1.0.0.tar) && $(MOVE) `dirname .tmp/jr1.0.0`/jr1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/jr1.0.0
...
compiler_moc_header_make_all: moc_client.cpp moc_server.cpp moc_ui.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_client.cpp moc_server.cpp moc_ui.cpp
